...
#define WIFI_SSID "Casomai"//**Your SSID here**
#define WIFI_PWD "SGrande@5"//**Your password here** leave empty if open (bad!)
...
#define MQTT_SERVER "192.168.5.130"//**IP address here of your MQTT server**
#define MQTT_USERNAME "rorenzo"//leave empty if not set (bad!)
#define MQTT_PASSWORD "apakapak"//leave empty if not set (bad!)
